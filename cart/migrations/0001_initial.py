    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('billing_adress', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.SET_NULL, related_name='billing_address', to='cart.address')),
                ('shipping_adress', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.SET_NULL, related_name='shipping_adress', to='cart.address')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('avaliable_colours', models.ManyToManyField(to='cart.colourvariation')),
                ('avaliable_sizes', models.ManyToManyField(to='cart.sizevariation')),
            ],
        ),
        migrations.CreateModel(
            name='Payment',
